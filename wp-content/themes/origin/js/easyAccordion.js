  ...
  jQuery.fn.easyAccordion = function (options) {
    ...
    this.each(function () {
      ...
      jQuery.fn.setVariables = function () {
        ...
        dtHeight =
          dlHeight -
          (jQuery(this).find("dt").outerWidth() -
            jQuery(this).find("dt").width());
        slideTotal = jQuery(this).find("dt").size();
        ddWidth =
          dlWidth -
          dtWidth * slideTotal -
          (jQuery(this).find("dd").outerWidth(true) -
            jQuery(this).find("dd").width());
        ddHeight =
          dlHeight -
          (jQuery(this).find("dd").outerHeight(true) -
            jQuery(this).find("dd").height());
      };
      ...
      if (jQuery.browser.safari) {
        ...
        var dtOffset = -dtTop; /* Safari and Chrome */
      }
      ...
      jQuery(this)
        ...
        .each(function () {
          jQuery(this).css({
            width: dtHeight,
            top: dtTop,
            "margin-left": dtOffset,
          });
          if (settings.slideNum == true) {
            jQuery('<span class="slide-number">' + 0 + f + "</span>").appendTo(
              this
            );
            if (jQuery.browser.msie) {
              var slideNumLeft =
              ...
              if (jQuery.browser.version == 8.0) {
                var slideNumTop = jQuery(this)
                  .find(".slide-number")
                  .css("bottom");
                var slideNumTopVal =
                  parseInt(slideNumTop) +
                  parseInt(jQuery(this).css("padding-top")) -
                  12;
                jQuery(this)
                  .find(".slide-number")
                  .css({ bottom: slideNumTopVal });
              }
            } else {
              var slideNumTop = jQuery(this)
                .find(".slide-number")
        ...
        jQuery(this)
          ...
          .each(function () {
            ...
            if (u <= activeID) {
              ...
              if (u < activeID) {
                // If the item sits to the left of the active element
                jQuery(this)
                  .next()
                  .css({ left: leftDtPos + dtWidth });
              } else {
                // If the item is the active one
      ...
      jQuery.fn.rotateSlides = function (slideInterval, timerInstance) {
        ...
        jQuery(this)
          .find("dt:eq(" + (newSlide - 1) + ")")
          .activateSlide(); // activate the new slide
      };
